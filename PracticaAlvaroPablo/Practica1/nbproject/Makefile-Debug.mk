...
${OBJECTDIR}/Algoritmo.o: Algoritmo.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Algoritmo.o Algoritmo.cpp

${OBJECTDIR}/LogCoco.o: LogCoco.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/LogCoco.o LogCoco.cpp

${OBJECTDIR}/Opciones.o: Opciones.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Opciones.o Opciones.cpp
